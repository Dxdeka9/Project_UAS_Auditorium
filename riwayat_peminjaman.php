      ...
      <div class="col-md-10 p-4">
         <div class="col-md-10 mb-3">
            <input type="text" id="search" class="form-control"
               placeholder="Cari berdasarkan nama, tanggal, atau peminjam"
               value="<?= htmlspecialchars($search_data); ?>">
         </div>
            ...
            <table class="table table-striped table-hover">
               ...
               <tbody id="search-results">
                  ...
                  <tr>
                     ...
                     <td>
                        <?php echo "<a href='?delete_id=' class='btn btn-danger' onclick='return confirm(\"Apakah Anda yakin ingin menghapus auditorium ini?\");'>Delete</a>" ?>
                     </td>
