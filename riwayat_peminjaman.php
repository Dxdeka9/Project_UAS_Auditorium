...
$search = '%' . $search_data . '%'; // Tambahkan wildcard untuk LIKE

// Query untuk mengambil data berdasarkan search term
$sql = "SELECT r.id_peminjaman, a.nama_auditorium, r.peminjam, r.tanggal_pinjam, r.waktu_mulai, r.waktu_selesai, r.foto_surat, r.status
        FROM riwayat_peminjaman r
        INNER JOIN auditorium a ON r.id_auditorium = a.id_auditorium
        WHERE (a.nama_auditorium LIKE ? OR r.peminjam LIKE ? OR r.tanggal_pinjam LIKE ?)
